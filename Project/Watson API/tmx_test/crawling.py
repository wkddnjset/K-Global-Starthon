...
for i in range(28, 50):
    pg_num = str(i)
    pg_url = 'http://www.dbpia.co.kr/SearchResult/Search?q=%28%5B%EB%94%A5%EB%9F%AC%EB%8B%9D%C2%A7coldb%C2%A72%C2%A799%C2%A73%5D%29&searchWord=%EC%A0%84%EC%B2%B4%3D%5E%24%EB%94%A5%EB%9F%AC%EB%8B%9D%5E*&Collection=0&nSort=1&nSorttype=desc&Page='+pg_num+'&nPagesize=20&searchAll=%EB%94%A5%EB%9F%AC%EB%8B%9D&Multimedia=0&specificParam=0&isFullText=1'
